    ...
    <AnimatePresence>
      {
        ...
        >
          ...
          <Link href={"/login"}>
            <button className="border text-sm font-medium relative border-neutral-200 dark:border-white/20 text-black dark:text-white px-4 py-2 rounded-full cursor-pointer">
              <span>Login</span>
