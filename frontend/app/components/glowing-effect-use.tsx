...
const GridItem = ({
  ...
  return (
    <li className={`min-h-56 list-none ${area}`}>
      <div
        className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3 bg-cover bg-center bg-no-repeat"
